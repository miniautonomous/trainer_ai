...
class StatelessRegressionGrouped(Model):
    def __init__(self, network_dictionary: dict):
        ...
        """
        super(StatelessRegressionGrouped, self).__init__(network_dictionary=network_dictionary)
    ...
    def build_graph(self, x: tf.Tensor) -> keras.Model:
        ...
        x = derived_layers.grouped_convolution_block(x,
                                                     cardinality=4,
                                                     kernel_size=(3, 3),
                                                     channels_in=48,
                                                     batch_norm=True,
